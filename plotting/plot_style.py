...
def ignore_type(obj: Any) -> Any:
    """Helper function to ignore type checking for dynamic plt.rcParams access."""
    return obj
...
# Seaborn colorblind palette reordered: dark blue, dark orange, grey, pink, orange, green, light blue...
ALT_CYCLE = [
    '#0173B2', '#D55E00', '#949494', '#CC78BC', '#DE8F05',
    '#029E73', '#56B4E9', '#FBAFE4', '#CA9161', '#ECE133',
]
# Annotation
...
def _install_brand_fonts() -> str:
    ...
    #         logger.warning(f"Font {font.name} already exists in {font_dir}. Skipping copy.")
    #     else:
    #         try:
